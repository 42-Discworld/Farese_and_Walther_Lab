...
#         R version 3.6.2 , Rstudio Version 1.3.1056 for current work.
...
#         
# Usage:  source("FWL_lipidomics_1.4.R") 
#      
...
source("FWL_lipidomics_1.4.FUNCTIONS.R", echo = TRUE)
...
# QC part I
##########################################################################################
source("FWL_lipidomics_QC_1.4.R", echo = FALSE)
...
###########################################################################################
source("FWL_lipidomics_QUANTIFICATION_1.4.R", echo = FALSE)
...
source("FWL_FattyAcids_Saturation_1.4.R", echo = FALSE)
...
##########################################################################################
source("FWL_FattyAcids_Length_1.4.R", echo = FALSE)
...
source("FWL_EtherLipids_1.4.R", echo = FALSE)
